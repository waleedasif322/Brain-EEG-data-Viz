...
#Generates signal file with filtered signals based on intervals file, mean signal subtracted, and sampled at 30fps/sec	
...
#generates signal files one for each channel filtered based on intervals
...
#takes channel signal file and returnes sampled version of it 	
...
temp = compute_averages(sigfiles)
